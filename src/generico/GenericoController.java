...
/**
 * <strong>Generico Controller</strong> <br>
 * Clase Genérica Controladora que todo 
 * ManagedBean debe implementar.
 * 
 * @author CruzadoJ
 *
 */
public abstract interface GenericoController {
	
	public enum AccionSolicitada {
		NUEVO, REGISTRAR, ACTUALIZAR, ELIMINAR, INACTIVAR, EJECUTAR, BUSCAR, EDITAR, VER, SALIR, LISTAR, IMPRIMIR
	}
	 ...
	 * 
	 * @return una cadena que representa la regla de navegacion de la pagina que
	 *         se mostrara al finalizar la llamada al metodo
	 * @throws Exception
	 *             the exception
	 */
